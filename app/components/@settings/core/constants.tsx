...
export const TAB_LABELS: Record<TabType, string> = {
  ...
  features: 'Functies & updates',
  data: 'Gegevensbeheer',
  'cloud-providers': 'Cloudproviders',
  'local-providers': 'Lokale providers',
  github: 'GitHub',
  gitlab: 'GitLab',
  netlify: 'Netlify',
  vercel: 'Vercel',
  supabase: 'Supabase',
  'event-logs': 'Systeemevenementen',
  mcp: 'MCP-servers',
};

export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  profile: 'Beheer je profiel- en accountinstellingen',
  settings: 'Pas voorkeuren en thema aan',
  notifications: 'Bekijk en beheer je meldingen',
  features: 'Ontdek nieuwe en aankomende functies',
  data: 'Beheer gegevensopslag, exports en import',
  'cloud-providers': 'Configureer cloudgebaseerde AI-providers en modellen',
  'local-providers': 'Stel lokale of self-hosted AI-providers in',
  github: 'Verbind en beheer GitHub-integratie',
  gitlab: 'Verbind en beheer GitLab-integratie',
  netlify: 'Configureer Netlify-deployments',
  vercel: 'Beheer Vercel-projecten en deployments',
  supabase: 'Koppel Supabase-databases en projecten',
  'event-logs': 'Bekijk systeemgebeurtenissen en logboeken',
  mcp: 'Beheer MCP-servers (Model Context Protocol)',
};
